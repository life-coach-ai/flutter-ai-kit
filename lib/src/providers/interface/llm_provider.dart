...
abstract class LlmProvider implements Listenable {
  ...
  /// the LLM.
  ///
  /// [editedUserMessageId] is the stable id of the **previous** user message
  /// when this send continues a turn after **edit** or **regenerate** (the chat
  /// UI may have removed that user message from [history] already). Persisted
  /// backends use it to know what to replace; in-memory providers ignore it.
  /// Always **null** for a normal append-only message (new turn).
  ///
  /// Returns a [Stream] of [String] containing the generated text chunks. This
  /// allows for streaming responses as they are generated by the LLM.
